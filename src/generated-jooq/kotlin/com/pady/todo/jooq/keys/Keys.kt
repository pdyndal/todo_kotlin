...
val TODO_T_ID_PK: UniqueKey<TodoRecord> = Internal.createUniqueKey(Todo.TODO, DSL.name("TODO_T_ID_PK"), arrayOf(Todo.TODO.T_ID), true)
...
val TODO_U_ID_FK: ForeignKey<TodoRecord, UserRecord> = Internal.createForeignKey(Todo.TODO, DSL.name("TODO_U_ID_FK"), arrayOf(Todo.TODO.U_ID), com.pady.todo.jooq.keys.USER_U_ID_PK, arrayOf(User.USER.U_ID), true)
